...
public class ProfileView2 extends Div {
    ...
    ProfileView2(SelectedProfileService selectedProfileService,
    ...
    private VerticalLayout createDialogLayout(Dialog dialog, SelectedProfileService selectedProfileService) {
